...
<html>
  <head>
    ...
    $(document).ready(function () {
      var word_list = [
        {text: "Lorem", weight: 180, link: "https://github.com/DukeLeNoir/jQCloud"},
        {text: "Ipsum", weight: 105, html: {title: "My Title", "class": "custom-class"}, link: {href: "http://jquery.com/", target: "_blank"}},
